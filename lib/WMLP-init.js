...
if (typeof(global.TEST_PLATFORM) == "undefined") {
    if (WMLPjson.platform.test == "ubuntu" ||
        ...
        global.TEST_PLATFORM = WMLPjson.platform.test;
    } else {
        throw new Error("Can not support this platform: " + WMLPjson.platform.test);
    }
}

if (typeof(global.RUN_PLATFORM) == "undefined") {
    if (WMLPjson.platform.run == "ubuntu" ||
        WMLPjson.platform.run == "mac" ||
        WMLPjson.platform.run == "window") {
        global.RUN_PLATFORM = WMLPjson.platform.run;
    } else {
        throw new Error("Can not support this platform: " + WMLPjson.platform.run);
    }
}

if (typeof(global.WEBML_SWITCH) == "undefined") {
    if (typeof(WMLPjson.webmlpolyfill) == "boolean") {
        global.WEBML_SWITCH = WMLPjson.webmlpolyfill;
    } else {
...
if (typeof(global.PASS_WORD) == "undefined") {
    if (global.RUN_PLATFORM == "ubuntu") {
        global.PASS_WORD = WMLPjson.password.ubuntu;
    } else if (global.RUN_PLATFORM == "mac") {
        global.PASS_WORD = WMLPjson.password.mac;
    } else if (global.RUN_PLATFORM == "window") {
...
if (typeof(global.DOWNLOAD_FLAG) == "undefined") {
    global.DOWNLOAD_FLAG = WMLPjson.downloadflag;
}

if (typeof(global.WRITE_DLFLAG) == "undefined") {
    global.WRITE_DLFLAG = function(flag) {
        global.DOWNLOAD_FLAG = flag;
        WMLPjson.downloadflag = flag;
    }
}
