...
class modules_json {
    ...
    getWebmlSwitch() {
        if (typeof(this.json.webml.switch.linux.IEMYRIAD) == "boolean" &&
            typeof(this.json.webml.switch.linux.INFERENCE_ENGINE) == "boolean" &&
...
GET_PREFER_MODELS = function() {
    ...
    if (WEBML_PREFER == "all") {
        if (TEST_PLATFORM == "linux") {
            if (WEBML_SWITCH.linux.IEMYRIAD) {
                ...
                if (WEBML_SWITCH.linux.INFERENCE_ENGINE) {
                    ...
                    preferArray.push("Linux-WebNN-Ultra-Low-IE-GNA");
                }
            }
        } else if (TEST_PLATFORM == "android") {
            ...
            if (WEBML_SWITCH.windows.INFERENCE_ENGINE) {
                preferArray.push("Win-WebNN-Fast-IE-MKLDNN");
                preferArray.push("Win-WebNN-Sustained-IE-clDNN");
                preferArray.push("Win-WebNN-Low-IE-MYRIAD");
                preferArray.push("Win-WebNN-Ultra-Low-IE-GNA");
            }
        }
    } else {
        if (TEST_PLATFORM == "linux") {
            if (WEBML_SWITCH.linux.IEMYRIAD) {
                if (WEBML_PREFER == "Linux-WebNN-Low-IE-MYRIAD") {
                    ...
                    let str = WEBML_PREFER + " is incorrect because 'IEMYRIAD' switch is true";
                    throw new Error(str);
                }
            } else {
                if (WEBML_PREFER == "Linux-Polyfill-Fast-WASM" ||
                    ...
                    if (WEBML_PREFER == "Linux-WebNN-Low-IE-MYRIAD") {
                        let str = WEBML_PREFER + " is incorrect because 'IEMYRIAD' switch is false";
                        throw new Error(str);
                    } else {
